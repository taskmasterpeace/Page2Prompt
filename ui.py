...
class PageToPromptUI:
    ...
    def create_input_fields(self, parent):
        ...
        self.style_prefix_entry = ttk.Entry(prefix_frame, width=50)
        ...
        suffix_frame = ttk.Frame(scrollable_frame)
        suffix_frame.pack(fill="x", pady=5)
        ttk.Label(suffix_frame, text="Suffix:").pack(side="left")
        self.style_suffix_entry = ttk.Entry(suffix_frame, width=50)
        ...
        generate_details_btn = ttk.Button(suffix_frame, text="Generate Style Details", command=self.generate_style_details)
        generate_details_btn.pack(side="right", padx=(5, 0))
